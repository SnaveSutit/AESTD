...
scoreboard players set #aestd aestd.math -1
scoreboard players operation #aestd aestd.wbdiameter *= #aestd aestd.math

scoreboard players set #aestd aestd.math 40000000
scoreboard players operation #aestd aestd.math /= #aestd aestd.wbdiameter

# Dividing into seconds and centiseconds
scoreboard players set #100 aestd.math.var 100
scoreboard players operation #aestd aestd.math.var = #aestd aestd.math
scoreboard players operation #aestd aestd.math.var /= #100 aestd.math.var
scoreboard players operation #aestd aestd.math.var2 = #aestd aestd.math
